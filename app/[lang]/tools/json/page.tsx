      ...
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-slate-400 mt-2">
              {dict.dashboard.tools.json.desc}
            </p>
          </div>
        </div>
        ...
        <div className="hidden sm:flex items-center space-x-2 bg-black/50 border border-white/10 rounded-full px-4 py-2">
            ...
            <span className={`text-sm font-medium ${
               ...
               {status === "idle" ? "Ready" : status === "valid" ? dict.tools.json.valid : dict.tools.json.invalid}
            </span>
        </div>
      </div>
            ...
            >
              {copied ? (
                ...
                <>
                  ...
                  <span>{dict.tools.json.copy}</span>
                </>
              )}
            </button>
          </div>
