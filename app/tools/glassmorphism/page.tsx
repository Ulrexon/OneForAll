      ...
      <div className="mb-8 flex items-start mt-4">
        ...
        <div>
          ...
          <p className="text-slate-400 text-lg">
            Visually generate the incredibly satisfying frosted-glass CSS effect in seconds.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-8 flex-grow">
               ...
               <div>
                  <div className="flex justify-between text-sm mb-3">
                     <label className="text-slate-300 font-medium">Blur Value (px)</label>
               ...
               <div>
                  <div className="flex justify-between text-sm mb-3">
                     <label className="text-slate-300 font-medium">Transparency (Opacity)</label>
               ...
               <div>
                  <div className="flex justify-between text-sm mb-3">
                     <label className="text-slate-300 font-medium">Outline Sharpness</label>
               ...
               <div>
                  <label className="text-slate-300 font-medium block mb-3 text-sm">Base Frosting Color</label>
