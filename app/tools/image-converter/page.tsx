...
export default function ImageConverter() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-8">
        <Link href="/" className="text-indigo-400 hover:text-indigo-300 transition-colors text-sm flex items-center mb-4">
        ...
        <p className="text-slate-400 text-lg">
          Convert images seamlessly between PNG, JPEG, and WebP entirely in your browser. Fast, secure, and fully private.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          ...
          <h3 className="text-xl font-semibold mb-2 text-white/90">Click to upload or drag & drop</h3>
        ...
        <div className="flex flex-col gap-6">
          <div className="p-6 rounded-3xl bg-black/40 border border-white/10 backdrop-blur-md">
            <h3 className="text-xl font-medium text-white mb-6">Conversion Settings</h3>
            
            <div className="space-y-6">
              <div>
                <label className="block text-sm text-slate-400 mb-3">Target Format</label>
                ...
                <div className="pt-2">
                  <div className="flex justify-between text-sm mb-3">
                    <label className="text-slate-400 flex items-center">
                      <span className="font-medium mr-2">Compression Quality</span>
